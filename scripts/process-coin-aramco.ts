/**
 * Process Aramco.png — DEFI coin with "العملة السعودية" calligraphy.
...
const SOURCE_UPLOAD = '/home/z/my-project/upload/Aramco.png'
const SOURCE = path.join(PUBLIC_DIR, 'alarab-coin-aramco.png')
const OUTPUT = path.join(PUBLIC_DIR, 'alarab-coin-aramco-clean.png')
...
async function main() {
  ...
  for (let i = 0; i < width * height; i++) {
    ...
    // Dark pixels (engravings, sword, shadows): keep
    const isDark = max < 90
