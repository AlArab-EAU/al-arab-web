      ...
      <div className="relative aspect-video overflow-hidden">
        {!playing ? (
          <>
            ...
            >
              <span className="relative flex h-20 w-20 items-center justify-center rounded-full border border-[#c9a85c]/60 bg-[#0f0f1a]/40 backdrop-blur-md transition-all duration-500 group-hover/btn:scale-110 group-hover/btn:border-[#d4af37]">
            ...
            <div className="absolute left-5 top-5 flex items-center gap-2">
              <span className="rounded-full border border-[#c9a85c]/40 bg-[#0f0f1a]/70 px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.25em] text-[#d4af37]">
                {officialBadge}
              </span>
              {languageLabel && (
  ...
  return (
    <>
      ...
      {expanded && (
        ...
        >
          <div className="absolute inset-0 bg-[#0f0f1a]/95 backdrop-blur-xl" />
          <button
            className="absolute right-6 top-6 z-10 rounded-full border border-[#c9a85c]/40 bg-[#0f0f1a]/70 p-3 text-[#f4e9c9] transition hover:bg-[#c9a85c]/15"
            onClick={() => setExpanded(false)}
