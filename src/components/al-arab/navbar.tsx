    ...
    <>
      ...
      <AnimatePresence>
        {open && (
          ...
          >
            <div
              className="absolute inset-0 bg-[#0a2e5c]/90 backdrop-blur-xl"
            ...
            <motion.nav
              ...
              className="absolute right-0 top-0 flex h-full w-72 flex-col gap-2 border-l border-[#c9a85c]/25 bg-[#0b3a6b] px-6 py-8"
            >
