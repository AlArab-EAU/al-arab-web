          ...
          <div>
            ...
            <div className="mt-6 flex flex-col gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[10px] uppercase tracking-[0.25em] text-[#1565a8]">
                    {it.emailLabel}
                  </p>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <label className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  className="rounded-lg border border-[#c9a85c]/25 bg-[#082740]/60 px-4 py-3 text-sm text-[#f4e9c9] outline-none transition-colors focus:border-[#d4af37]"
            ...
            <label className="flex flex-col gap-1.5">
              ...
              <textarea
                ...
                className="resize-none rounded-lg border border-[#c9a85c]/25 bg-[#082740]/60 px-4 py-3 text-sm text-[#f4e9c9] outline-none transition-colors focus:border-[#d4af37]"
                placeholder={it.fields.messagePlaceholder}
              />
            </label>
            <button
              type="submit"
              className="group relative mt-2 flex items-center justify-center gap-2 overflow-hidden rounded-lg bg-gradient-to-r from-[#d4af37] via-[#c9a85c] to-[#8a6f2e] px-6 py-3 text-sm font-semibold uppercase tracking-[0.22em] text-[#0b4065] transition-all hover:scale-[1.01]"
            >
