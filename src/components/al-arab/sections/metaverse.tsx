    ...
    <Section id="metaverse">
      ...
      <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-5">
        ...
        >
          ...
          <p className="text-sm leading-relaxed text-[#a8b8c8]">
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
            {mt.districts.map((d, i) => (
              <motion.div
                ...
                className="rounded-xl border border-[#c9a85c]/20 bg-[#0b3a6b]/60 p-4 backdrop-blur-md"
              >
                ...
                <p className="mt-2 text-xs leading-relaxed text-[#a8b8c8]">
                  {d.description}
                </p>
              </motion.div>
            ))}
        ...
        {mt.capabilities.map((c, i) => {
          ...
          return (
            ...
            >
              ...
              <p className="text-[11px] leading-relaxed text-[#a8b8c8]">
                {c.description}
              </p>
            </motion.div>
          )
