      ...
      <div className="relative mx-auto max-w-7xl px-5 py-16 md:px-8">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-5">
          ...
          >
            ...
            <p className="mt-6 max-w-sm text-sm leading-relaxed text-[#b8c5d6]">
              {ft.tagline}
            </p>
                ...
                {col.items.map((item, j) => (
                  <li key={item}>
                    <a
                      ...
                      className="group inline-flex items-center gap-2 text-sm text-[#b8c5d6] transition-colors hover:text-[#f4e9c9]"
                    >
