...
export function Footer() {
  ...
  return (
    <footer className="relative mt-32 border-t border-[#c9a85c]/15 bg-[#0a1a3a]">
      ...
      <div className="relative mx-auto max-w-7xl px-5 py-16 md:px-8">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-5">
          ...
          >
            ...
            <p className="mt-6 max-w-sm text-sm leading-relaxed text-[#a8c5e8]">
              {ft.tagline}
            </p>
            <div className="mt-6 flex gap-3">
              {SOCIAL_ICONS.map((Icon, i) => (
                <a
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-lg border border-[#c9a85c]/25 bg-[#0d2657]/60 text-[#c9b88a] transition-all hover:border-[#d4af37] hover:text-[#d4af37] hover:shadow-gold"
                >
                ...
                {col.items.map((item, j) => (
                  <li key={item}>
                    <a
                      ...
                      className="group inline-flex items-center gap-2 text-sm text-[#a8c5e8] transition-colors hover:text-[#f4e9c9]"
                    >
        ...
        <div className="mt-16 flex flex-col items-center justify-between gap-6 border-t border-[#c9a85c]/10 pt-8 md:flex-row">
          <p className="text-center text-[11px] leading-relaxed text-[#4a7bc4] md:text-left">
            {ft.copyright}
          </p>
          <a
            href="#top"
            className="group flex items-center gap-2 rounded-full border border-[#c9a85c]/30 bg-[#0d2657]/60 px-4 py-2 text-[10px] font-semibold uppercase tracking-[0.25em] text-[#c9b88a] transition-all hover:border-[#d4af37] hover:text-[#f4e9c9]"
          >
            {ft.backToTop}
