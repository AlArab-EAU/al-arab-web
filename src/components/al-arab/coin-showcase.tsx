  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative mt-8 flex items-start gap-3 rounded-xl border border-[#c9a85c]/15 bg-[#030a14]/50 p-4"
      >
...
function CoinCard({
  ...
  return (
    <motion.figure
      ...
      className="group relative flex flex-col items-center gap-2 rounded-2xl border border-[#c9a85c]/20 bg-[#030a14]/40 p-3 backdrop-blur-md"
    >
      <SpinningCoin
        src={src}
        alt={alt}
      ...
      <figcaption className="flex flex-col gap-1 text-center">
        ...
        <span className="text-[9px] leading-relaxed text-[#6a8db0]">
          {caption}
        </span>
      </figcaption>
    </motion.figure>
